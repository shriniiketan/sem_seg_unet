...
image = glob.glob('C:\SelfDrivingMaterials\training\image_2\*.png')


for i in image :
    image_color = mpimg.imread(i)
    train_images.append(image_color)
...
train_masks = [] 
image_mask = glob.glob('C:\SelfDrivingMaterials\training\semantic\*.png')


for i in image_mask :
    image_mask_color = cv2.imread(i)
    train_masks.append(image_mask_color)
